...
.controller('HomeController', ['$scope', '$timeout', 'email', function($scope, $timeout, email) {
  ...
  $scope.videos = [
    ...
    {description: 'Meetmeagain.com helps you reconnection with connections that you did not get a chance to exchange contact info with', url:'https://www.youtube.com/watch?v=V6TAaANCPfY', provider: 'youtube'},
  ...
  $scope.sendEmail = function(form) {
    email.mandrill('Zt9VJPNzZOrqVhOrUH3-Uw', 'benhalverson@me.com', form.email, form.message, form.subject, form.name)
